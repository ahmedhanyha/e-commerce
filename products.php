...
<html>
  ...
  <div class="container-fluid nav ">
      <div class="justify-content-center nav-tabs nav-justified">
        ...
        <!-- mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm -->
              ...
              <div class="row text-center">
                  ...
                  <div class="col-md-3 col-sm-6">
                   ...
                   <div class="col-md-3 col-sm-6">
                      <div class="thumbnail">
                          <img src="img/54.jpg" alt="Responsive image">
                          <div class="caption">
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="thumbnail">
                          <img src="img/53.jpg" alt="Responsive image" id="imgs">
                          <div class="caption">
                              <h3>H&W</h3>
                              <p>Price:Rs.800.00</p>
                              <?php 
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="thumbnail">
                          <img src="img/52.jpg" alt="Responsive image">
                          <div class="caption">
                              <h3>luis Phil</h3>
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="thumbnail">
                          <img src="img/51.jpg" alt="Responsive image">
                          <div class="caption">
                              <h3>John Zok</h3>
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="thumbnail">
                          <img src="img/50.jpg" alt="Responsive image">
                          <div class="caption">
                              <h3>Jhalsani</h3>
